  ...
  <div class="container d-flex flex-wrap" v-if="store.singleProject">
    ...
    <div class="card mb-3">
      ...
      <div class="card-body">
        ...
        <h5 class="card-title">Progetto: {{ store.singleProject.name }}</h5>
        <p class="card-text">Descrizione: {{ store.singleProject.description }}</p>
        <a :href="store.singleProject.link" target="_blank" class="card-text d-block">Guarda repository su Github</a>
        ...
        <router-link :to="{ name: 'Projects' }" class="btn btn-outline-danger mt-2">
